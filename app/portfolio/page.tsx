    ...
    <main dir="rtl" className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="pt-32 pb-12 relative overflow-hidden">
        ...
        <div className="container px-4 mx-auto relative z-10">
          <SectionHeader
            ...
            description="جولة في المشاريع التي ساعدت فيها العلامات التجارية على النمو والانتشار."
            isInView={true}
          />
        </div>
      </section>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
         <div className="container px-4 mx-auto text-center">
            <h3 className="text-3xl font-bold mb-6 text-gray-800 dark:text-white">هل أعجبتك هذه الأعمال؟</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-xl mx-auto">
                دعنا نصنع قصة نجاح مشابهة لعلامتك التجارية.
            </p>
            <a 
                href="/contact" 
