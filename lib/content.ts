...
export const HERO_CONTENT = {
  ...
  description: {
    ...
    continuation: "أعمل مع العلامات التجارية الطموحة التي تريد بناء حضور مؤثر وتحقيق نتائج حقيقية من خلال الكتابة الاستراتيجية.",
  },
  cta: {
    primary: {
      label: "لنصنع الأثر",
...
export const FOOTER_CONTENT = {
  brand: {
    name: "إسماعيل إبراهيم",
    tagline: "كاتب محتوى إبداعي",
    description: "كلمات تبيع، وقصص تُلهم. أحول أفكارك إلى محتوى يؤثر ويحقق النتائج. دعنا نصنع الفرق معاً.",
  },
  navigation: [
    { name: "الرئيسية", href: "#" },
...
export const CONTACT_CONTENT = {
  ...
  form: {
    ...
    message: {
      label: "الرسالة",
      placeholder: "اكتب رسالتك هنا... أخبرني المزيد عن مشروعك واحتياجاتك.",
      error: "يرجى كتابة رسالتك",
    },
    additionalInfo: {
      title: "معلومات إضافية (اختياري)",
      description: "هذه المعلومات تساعدني على فهم احتياجاتك بشكل أفضل وتقديم عرض أكثر دقة.",
      goal: {
        label: "الهدف من المشروع",
        placeholder: "مثال: زيادة المبيعات، بناء العلامة التجارية، تحسين التحويل...",
      },
      timeline: {
...
export const CASE_STUDIES_CONTENT = {
  ...
  cta: {
    ...
    description: "دعنا نعمل معاً لتحويل علامتك التجارية من خلال الكلمات الاستراتيجية.",
...
export const SERVICES_PAGE_CONTENT = {
  ...
  pricing: {
    ...
    description: "كل مشروع فريد من نوعه. تواصل معي لنناقش احتياجاتك ونبني استراتيجية تناسب ميزانيتك وأهدافك.",
    cta: "استشرني الآن",
    href: "/contact",
  },
} as const;
