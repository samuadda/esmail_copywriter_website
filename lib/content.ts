...
export const SERVICES_FAQ_CONTENT = {
	faqTitle: "أسئلة شائعة عن الخدمات",
	faqItems: [
		{
			question: "ماذا يحدث إذا لم أكن راضياً عن النتيجة؟",
			answer: "أقدم جولتين من التعديلات المجانية لكل مشروع. إذا لم نصل إلى نتيجة ترضيك بعد التعديلات، نناقش الوضع معاً لإيجاد حل عادل للطرفين.",
		},
		{
			question: "كيف يتم التواصل خلال المشروع؟",
			answer: "نتواصل عبر واتساب أو البريد الإلكتروني حسب تفضيلك. أبدأ كل مشروع بمكالمة قصيرة لفهم احتياجاتك بالضبط، ثم أرسل التحديثات في المراحل المهمة.",
		},
		{
			question: "هل تعمل مع المشاريع الصغيرة والمبتدئة؟",
			answer: "نعم، أعمل مع مختلف أحجام المشاريع. المعيار الأساسي ليس الحجم، بل وجود رؤية واضحة والرغبة في الاستثمار في جودة المحتوى. تواصل معي لنرى هل نحن مناسبان لبعض.",
		},
		{
			question: "كم يستغرق تسليم المشروع؟",
			answer: "يعتمد على نوع الخدمة: Strategy Sprint يُسلَّم خلال 3-5 أيام بعد الجلسة، سكربتات Story Factory خلال يومين لكل سكربت، والمشاريع الكبيرة نحدد جدولها الزمني في المكالمة الأولى.",
		},
		{
			question: "هل يمكنني الجمع بين أكثر من خدمة؟",
			answer: "بالتأكيد. كثير من عملائي يبدأون بـ Strategy Sprint لتحديد الأولويات، ثم ينتقلون إلى Story Factory أو Advisory. في المكالمة الأولى نحدد ما يناسب مشروعك ومرحلتك الحالية.",
		},
	],
} as const;
